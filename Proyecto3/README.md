...
**Complicaciones durante el desarrollo del proyecto:**
    ...
    si la aplicación detecta que está corriendo dentro de Shoes, 
    la estrategia Manual se comporta temporalmente como una estrategia Uniforme, eligiendo una jugada aleatoria para evitar el bloqueo. Otro reto fue el manejo de los parámetros de 
    ...
    desarrollar lógica de parsing robusta dentro de los constructores de estas clases para convertir esa 
    cadena de texto ("piedra,papel,tijera" o "piedra:2,papel:1") en listas de símbolos o Hashes de pesos, respectivamente, asegurando la normalización de 
    ...
    un estado interno (stateful), almacenando las últimas jugadas de ambos jugadores para alimentar correctamente las estrategias con memoria 
    (como Copiar y Pensar) en cada llamada a siguiente_ronda, lo cual es crucial para gestionar el flujo del juego, el 
